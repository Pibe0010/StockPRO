...
import { ContentActionsTable, Pagination, UserStore, v } from "../../../index.js";
import Swal from "sweetalert2";
import { CgArrowsExchangeAltV } from "react-icons/cg";
import { TiArrowSortedDown, TiArrowSortedUp } from "react-icons/ti";
import { useState } from "react";

export const UsersTable = ({ data, setOpenRegister, setDataSelect, setAction }) => {
  ...
  const columns = [
    {
      ...
      header: "Names",
      cell: (info) => (
        <div className="contentCell" data-title="Names">
    ...
    },
    {
      ...
      header: "Roles",
      cell: (info) => (
        <div className="contentCell" data-title="Roles">
          <span>{info.getValue()}</span>
        </div>
      ),
    },
    {
      ...
      enableSorting: false,
      cell: (info) => (
        <div className="contentCell" data-title="Status">
          <span>{info.getValue()}</span>
        </div>
      ),
    },
