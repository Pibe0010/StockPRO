...
export const ProductTable = ({ data, setOpenRegister, setDataSelect, setAction }) => {
  ...
  const deleteTable = (params) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        await deleteProduct({ id: params.id });
      }
    });
  };
  ...
  const columns = [
    ...
    {
      accessorKey: "price_sales",
      header: "P.sales",
      enableSorting: false,
      cell: (info) => (
        <div className="contentCell" data-title="P.sales">
          <span>{info.getValue()}</span>
        </div>
      ),
    },
    {
      accessorKey: "price_shopping",
      header: "P.shopping",
      enableSorting: false,
      cell: (info) => (
        <div className="contentCell" data-title="P.shopping">
          <span>{info.getValue()}</span>
        </div>
      ),
    },
    {
      ...
      enableSorting: false,
      cell: (info) => (
        <div className="contentCell" data-title="Category">
          <ColorContentTable
    ...
    },
    {
      ...
      enableSorting: false,
      cell: (info) => (
        <div className="contentCell" data-title="Brand">
          <span>{info.getValue()}</span>
        </div>
      ),
    },
